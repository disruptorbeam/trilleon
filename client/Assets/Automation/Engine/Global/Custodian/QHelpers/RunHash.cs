   ...
   public class RunHash {
      ...
      public string Get(string key, bool isTry = true) {
         ...
         if(_cache.KeyValListContainsKey(key)) {
            ...
            Q.assert.Fail(string.Format("Key \"{0}\" does not exist in cache. Cannot retrieve a value.", key));
      ...
      public void Remove(string key, bool isTry = true) {
         ...
         if(_cache.KeyValListContainsKey(key)) {
            ...
            Q.assert.Fail(string.Format("Key \"{0}\" does not exist in cache. Cannot complete remove command.", key));
