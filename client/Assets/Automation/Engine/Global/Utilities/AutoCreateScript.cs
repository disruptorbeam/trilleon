...
namespace TrilleonAutomation {
   ...
   public class AutoCreateScript {
      ...
      static Overseer overseer {
         get { 
            if(inspectOverseer ==  null){
               inspectOverseer = GameObject.Find("TestMonitorHelper").GetComponent<Overseer>();
            }
      ...
      public const string FAIL = "Q.assert.Fail(";
      public const string IS_TRUE = "Q.assert.IsTrue(";
      public const string ACTIVENESS = "Q.assert.IsActiveVisibleAndInteractable(";
      public const string IS_NULL = "Q.assert.IsNull(";
      #endregion
