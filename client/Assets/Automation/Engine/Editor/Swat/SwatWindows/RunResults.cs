	...
	public class RunResults : SwatWindow {
		...
		public override void Render() {
			...
			if(ReDrawAutomationReports) {
				...
				List<string> all = Directory.GetFiles(directory, "report.html", SearchOption.AllDirectories).ToList();
				...
				all = Directory.GetFiles(directory, "report.meta", SearchOption.AllDirectories).ToList();
