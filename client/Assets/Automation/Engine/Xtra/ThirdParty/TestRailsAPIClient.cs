...
namespace TrilleonAutomation {
   ...
   public class TestRailsAPIClient {        
      public static string TEST_URL_PATH = "/index.php?/tests/view/";
      private string m_user = "tsibiski@disruptorbeam.com";
      private string m_password = "Furion2017";
...
//#if UNITY_EDITOR
         //return "POST updates not sent to TestRails when tests are run in Unity Editor.";
//#else
      ...
      private string SendRequest(string method, string uri, string json) {
         ...
         try {
            ...
            if (ex != null) {
               ...
               AutoConsole.PostMessage(String.Format("TestRail API returned HTTP {0} ({1})",(int)response.StatusCode, error), MessageLevel.Abridged);
            }
