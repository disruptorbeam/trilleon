...
namespace TrilleonAutomation {
	...
	/// <summary>
	/// "UnityTest"; as in "Unit-like Test". Specifically designed to unit test methods and functionality that cannot be tests at compilation.
	/// Behaves very similar to regular integration automation tests in Trilleon, but optomized to NOT test things in the app as a user would.
	/// </summary>
	public class UnityTestBase : MonoBehaviour {
		...
		/// <typeparam name="C">The class containing the field.</typeparam>
		/// <typeparam name="RT">The return type to cast this field value as.</typeparam>
		public RT GetFieldValue<C,RT>(string fieldName) where C : MonoBehaviour {

			FieldInfo fieldInfo = typeof(C).GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
		...
		/// <typeparam name="C">The class containing the property.</typeparam>
		/// <typeparam name="RT">The return type to cast this property value as.</typeparam>
		public RT GetPropertyValue<C,RT>(string propertyName) where C : MonoBehaviour {

			PropertyInfo propertyInfo = typeof(C).GetProperty(propertyName, BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
		...
		public IEnumerator LaunchPrivateCoroutine<T>(GameObject obj, string methodName, params object[] args) where T : MonoBehaviour {
			...
			MethodInfo coroutine = monoType.GetMethod(methodName, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance);
			if(coroutine == null) {
