...
namespace TrilleonAutomation {
    ...
    public static class CommandConsoleBroker {
        ...
        public static ConsoleCommands Extended {
            get {
                //CUSTOMIZE: Your code here! Remove all but boolean if invoked by static method. Else, use this for instance.
                if(_extended == null) {
                    _extended = null;
                }
                extend = true;
        ...
        public static void SendCommand(string fullRawCommand) {
            ...
            if(extend) {
                ...
                //CUSTOMIZE: Add your custom code to send this command directly/programmatically to your command console's processor logic.

            } else {

                ConsoleCommandsBase.SendCommand(fullRawCommand);
